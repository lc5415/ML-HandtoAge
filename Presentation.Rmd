...
* __IN: Center and scale each image w.r.t. its mean and standard deviation.__
* __BN: Center and scale each image w.r.t. the whole batch of images mean and standard deviation__
...
Incorporating CHALE for shaper images as well as regularisation L2 norm and OneCyclePolicy
```{r}
